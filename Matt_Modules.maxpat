...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 738.0, 69.0, 355.0, 224.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 667.0, 503.0, 350.0, 224.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 7.0, 301.0, 652.0, 330.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 221.0, 69.0, 100.0, 222.0 ],
					"presentation" : 1,
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-5::obj-53" : [ "live.button", "live.button", 0 ],
			"obj-5::obj-58" : [ "hpFreq[2]", "hp", 0 ],
			"obj-8::obj-10" : [ "MaxStep", "max", 0 ],
			"obj-8::obj-22" : [ "beat1", "beat1", 0 ],
			"obj-8::obj-25" : [ "reset", "reset", 0 ],
			...
			"obj-8::obj-9" : [ "SeqLength", "length", 0 ],
			"parameterbanks" : 			{
