...
, 							{
								"box" : 								{
									...
									"restore" : 									{
										"Damp" : [ 0.25984251968504 ],
										"Dry" : [ 0.0 ],
										"Early" : [ 0.228346456692913 ],
										"Regen" : [ 0.118110236220472 ],
										"Size" : [ 41.173786347573689 ],
										"Spread" : [ 100.0 ],
										"Tail" : [ 0.753937007874015 ],
										"Time" : [ 30.330541810007862 ],
										"bypass" : [ 0.0 ]
									}
,
									"text" : "autopattr",
...
,
					"patching_rect" : [ 712.0, 639.0, 332.0, 116.0 ],
					"varname" : "Gigaverb",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 853.0, 171.0, 31.0, 22.0 ],
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 800.0, 23.0, 109.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 853.0, 143.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 800.0, 193.0, 29.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 800.0, 96.0, 103.0, 22.0 ],
					"text" : "matt.SineLFO 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 685.0, 290.0, 355.0, 224.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 15.0, 295.0, 652.0, 330.0 ],
					"presentation" : 1,
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Music/MaxPatches/MattAbstractions-main",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "matt.SineLFO.maxpat",
				"bootpath" : "~/Music/MaxPatches/MattAbstractions-main",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
